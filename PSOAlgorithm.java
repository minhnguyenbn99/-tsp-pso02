...
public class PSOAlgorithm {
	 public ArrayList<particle> particlesList = new ArrayList<particle>();
	    ...
	    public PSOAlgorithm(Route route)
	    {
	        ...
	        System.out.println(PSOConstants.maximumParticles );
	        System.out.println();
	    }
	    ...
	    public void printParticles()
	    {
	        for(int i = 0 ; i< this.particlesList.size()-1;i++)
	        {
	            ...
	            for(int j = 0 ; j < particle.problemSize-1 ; j++)
	            {
	                System.out.print("Position : "+this.particlesList.get(i).location.getLocations().get(j)+" , Velocity : "
